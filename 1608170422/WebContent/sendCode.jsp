...
<%@ page import="javax2.mail.Session" %>
...
<body>
<h1 style="margin: 50px 80px; color: darkgray; font-family: cursive;">欢迎来到学生信息管理系统</h1>
<%
...
<%
            ...
            try {
                ...
                message.setFrom(new InternetAddress("43493222.com"));
                ...
                transport.connect("smtp.qq.com", "4349332236@qq.com", "ylwaxdtbeogbcacc");
...
<%
            ...
            try {
                ...
                MimeMessage message = new MimeMessage(s);
                message.setFrom(new InternetAddress("43493232@qq.com"));
                message.setRecipient(Message.RecipientType.TO, new InternetAddress(toMail));
                ...
                Transport transport = s.getTransport("smtp");
                transport.connect("smtp.qq.com", "434932236@qq.com", "ylwaxdtbeogbcacc");
                transport.sendMessage(message, message.getAllRecipients());
                transport.close();
                session.setAttribute("reset", content);
%>
